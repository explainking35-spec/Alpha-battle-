...
BOT_TOKEN = "YOUR_BOT_TOKEN"  # <-- यहाँ अपना BotFather token डालो
CHANNEL_USERNAME = "@YourChannelUsername"  # <-- अपना channel username डालो
SERVER_URL = "https://your-domain.onrender.com"  # <-- Render URL बाद में डालना
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not await is_subscribed(user_id, context):
        ...
        return
    await update.message.reply_text("📤 कोई भी फ़ाइल भेजो — मैं direct download link दूँगा!")
